...
app.get('/community/', (req, res) => {
  const file = path.join(__dirname, 'community', 'index.html');
...
app.get('/community/index.html', (req, res) => {
  res.sendFile(path.join(__dirname, 'community', 'index.html'));
});

app.get('/community/admin', (req, res) => {
  res.redirect('/community/admin.html');
});

app.get('/community/admin.html', (req, res) => {
...
app.get('/api/docs', (req, res) => {
  res.json({ message: 'Forum API v1.0' });
});
